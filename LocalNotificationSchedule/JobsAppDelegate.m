...
@implementation JobsAppDelegate
...
- (void)applicationDidEnterBackground:(UIApplication *)application
{
    ...
    [self reorderApplocationIconBadgeNumber];
}
...
- (void)applicationWillEnterForeground:(UIApplication *)application
{
    ...
    [self reorderApplocationIconBadgeNumber];
    [[NSNotificationCenter defaultCenter] postNotificationName:@"RefershTableViewDatas" object:nil];
}
...
//App 執行時、使用中
//App 在背景、沒有使用時，點選了 橫幅、提醒，皆會呼叫此 method
...
- (void)reorderApplocationIconBadgeNumber {
